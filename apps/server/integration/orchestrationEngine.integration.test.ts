...
const FIXTURE_SESSION_ID = RuntimeSessionId.makeUnsafe("fixture-session");
const FIXTURE_THREAD_ID = ThreadId.makeUnsafe("fixture-thread");
const FIXTURE_TURN_ID = TurnId.makeUnsafe("fixture-turn");
      ...
      const turnResponse: TestTurnResponse = {
        events: [
          ...
          },
          {
            ...
            threadId: FIXTURE_THREAD_ID,
            turnId: FIXTURE_TURN_ID,
            payload: { streamKind: "assistant_text", delta: "Single turn response.\n" },
          },
          {
            type: "turn.completed",
      ...
      yield* harness.adapterHarness.queueTurnResponseForNextSession({
        events: [
          ...
          },
          {
            ...
            threadId: FIXTURE_THREAD_ID,
            turnId: FIXTURE_TURN_ID,
            payload: { itemType: "command_execution", status: "inProgress", title: "Edit file", detail: "README.md" },
          },
          {
            type: "item.completed",
            ...
            threadId: FIXTURE_THREAD_ID,
            turnId: FIXTURE_TURN_ID,
            payload: { itemType: "command_execution", status: "completed", title: "Edit file", detail: "README.md" },
          },
          {
            type: "content.delta",
            ...
            threadId: FIXTURE_THREAD_ID,
            turnId: FIXTURE_TURN_ID,
            payload: { streamKind: "assistant_text", delta: "Updated README to v2.\n" },
          },
          {
            type: "turn.completed",
      ...
      yield* harness.adapterHarness.queueTurnResponse(sessionId, {
        events: [
          ...
          },
          {
            ...
            threadId: FIXTURE_THREAD_ID,
            turnId: FIXTURE_TURN_ID,
            payload: { streamKind: "assistant_text", delta: "Updated README to v3.\n" },
          },
          {
            type: "turn.completed",
      ...
      yield* harness.adapterHarness.queueTurnResponseForNextSession({
        events: [
          ...
          },
          {
            ...
            threadId: FIXTURE_THREAD_ID,
            turnId: FIXTURE_TURN_ID,
            requestId: RuntimeRequestId.makeUnsafe("req-approval-1"),
            payload: { requestType: "command_execution_approval", detail: "Approve command execution" },
          },
          {
            type: "turn.completed",
      ...
      yield* harness.adapterHarness.queueTurnResponseForNextSession({
        events: [
          ...
          },
          {
            ...
            threadId: FIXTURE_THREAD_ID,
            turnId: FIXTURE_TURN_ID,
            payload: { message: "Sandbox command failed." },
          },
          {
            type: "turn.completed",
            ...
            threadId: FIXTURE_THREAD_ID,
            turnId: FIXTURE_TURN_ID,
            payload: { state: "failed", errorMessage: "Sandbox command failed." },
          },
        ],
      });
        ...
        yield* harness.adapterHarness.queueTurnResponseForNextSession({
          events: [
            ...
            },
            {
              ...
              threadId: FIXTURE_THREAD_ID,
              turnId: FIXTURE_TURN_ID,
              payload: { streamKind: "assistant_text", delta: "Claude first turn.\n" },
            },
            {
              type: "turn.completed",
        ...
        yield* harness.adapterHarness.queueTurnResponseForNextSession({
          events: [
            ...
            },
            {
              ...
              threadId: FIXTURE_THREAD_ID,
              turnId: FIXTURE_TURN_ID,
              payload: { streamKind: "assistant_text", delta: "Turn before restart.\n" },
            },
            {
              type: "turn.completed",
        ...
        yield* harness.adapterHarness.queueTurnResponseForNextSession({
          events: [
            ...
            },
            {
              ...
              threadId: FIXTURE_THREAD_ID,
              turnId: FIXTURE_TURN_ID,
              payload: { streamKind: "assistant_text", delta: "Turn after restart.\n" },
            },
            {
              type: "turn.completed",
        ...
        yield* harness.adapterHarness.queueTurnResponseForNextSession({
          events: [
            ...
            },
            {
              ...
              turnId: FIXTURE_TURN_ID,
              requestId: RuntimeRequestId.makeUnsafe("req-approval-1"),
              payload: { requestType: "command_execution_approval", detail: "Approve Claude tool call" },
            },
            {
              type: "turn.completed",
        ...
        yield* harness.adapterHarness.queueTurnResponseForNextSession({
          events: [
            ...
            },
            {
              ...
              threadId: FIXTURE_THREAD_ID,
              turnId: FIXTURE_TURN_ID,
              payload: { streamKind: "assistant_text", delta: "Long running output.\n" },
            },
            {
              type: "turn.completed",
        ...
        yield* harness.adapterHarness.queueTurnResponseForNextSession({
          events: [
            ...
            },
            {
              ...
              threadId: FIXTURE_THREAD_ID,
              turnId: FIXTURE_TURN_ID,
              payload: { streamKind: "assistant_text", delta: "README -> v2\n" },
            },
            {
              type: "turn.completed",
        ...
        yield* harness.adapterHarness.queueTurnResponse(sessionId, {
          events: [
            ...
            },
            {
              ...
              threadId: FIXTURE_THREAD_ID,
              turnId: FIXTURE_TURN_ID,
              payload: { streamKind: "assistant_text", delta: "README -> v3\n" },
            },
            {
              type: "turn.completed",
