...
- Renderer validates critical RPC success payload shapes (`app.health`, `app.bootstrap`, `providers.listSessions`, terminal/todo/provider control flows) and fails fast on malformed responses.
